...
class Baseset(db.Model):
    title = db.StringProperty(multiline=False,default='PyCon Mexico')
    subtitle = db.StringProperty(multiline=False,default='Primera conferencia oficial de Python en Mexico.')
    description = db.TextProperty(default='Portal de la PyConference en Mexico.')
    ...
    admin_email = db.StringProperty(multiline=False,default='jza@oooes.org')
